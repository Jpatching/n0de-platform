...
GOOGLE_OAUTH_REDIRECT_URI=https://api.n0de.pro/api/v1/auth/google/callback

# GitHub OAuth (Create at https://github.com/settings/developers)
GITHUB_CLIENT_ID=Ov23liYourGitHubClientID
GITHUB_CLIENT_SECRET=YourGitHubClientSecretHere
GITHUB_OAUTH_REDIRECT_URI=https://api.n0de.pro/api/v1/auth/github/callback
EOF
...
echo "📤 Step 2: Updating backend environment variables..."
cd /home/sol/n0de-deploy

# Disable billing by setting test mode
backend variables set BILLING_ENABLED=false
backend variables set STRIPE_TEST_MODE=true

# Set OAuth to optional mode for now
backend variables set OAUTH_REQUIRED=false
backend variables set AUTH_BYPASS_EMAIL_VERIFICATION=true

# Update CORS for all domains
backend variables set CORS_ORIGINS="https://n0de.pro,https://www.n0de.pro,https://n0de-website-*.vercel.app,http://localhost:3000,http://localhost:3001"

echo ""
echo "✅ backend variables updated"
...
echo "3. Update backend variables with real OAuth credentials"
