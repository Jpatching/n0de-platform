...
declare -A REDUNDANT_SCRIPTS=(
    ...
    ["scripts/configure-railway.sh"]="Railway configuration - obsolete after migration"
    ...
    ["scripts/railway-fix.sh"]="Railway fixes - obsolete after migration"
    ["scripts/set-railway-vars.sh"]="Railway variables - obsolete"
    ["scripts/smart-fix.sh"]="temporary fix script"
    ["scripts/sync-railway-env.sh"]="Railway sync - obsolete"
...
# Railway migration artifacts (keep railway-export if it exists)
delete_file "/home/sol/n0de-deploy/railway.json" "Railway config - obsolete after migration"
delete_file "/home/sol/n0de-deploy/init-railway-db.js" "Railway DB init script"
