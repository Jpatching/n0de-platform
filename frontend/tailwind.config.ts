...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // !! CRITICAL FIX: HTML uses bg-bg-main, text-text-primary (double prefix) !!
        // Original config had single prefix, HTML expects double prefix
        
        // Background colors (with bg- prefix to match HTML usage)
        ...
        // Text colors (with text- prefix to match HTML usage)
