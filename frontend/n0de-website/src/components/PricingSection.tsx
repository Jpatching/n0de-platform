...
export default function PricingSection() {
  ...
  const handleGetStarted = (planType: string) => {
    if (planType === 'Enterprise') {
      // For enterprise, could redirect to contact form or sales
      window.location.href = 'mailto:sales@n0de.pro?subject=Enterprise%20Plan%20Inquiry';
    } else {
      // For other plans, redirect to billing page
