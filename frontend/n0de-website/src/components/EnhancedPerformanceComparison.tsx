            ...
            >
              <p className="text-xl lg:text-2xl text-gray-300 mb-6 leading-relaxed">
                ...
                <span className="relative mx-2">
                  ...
                  <div className="absolute -bottom-1 left-0 w-full h-1 bg-gradient-to-r from-n0de-green to-n0de-blue rounded-full opacity-60"></div>
                </span>
          ...
          <div className="card mb-8">
            <div className="p-8">
              <div className="text-center mb-8">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    { label: 'Daily Bundle Volume', value: '13,902', icon: '📊' },
                    { label: 'Success Rate', value: '96.2%', icon: '✅' },
                    { label: 'Average Tip', value: '0.0051 SOL', icon: '💰' },
                    { label: 'Daily Profit', value: '$6,943.33', icon: '📈' }
                  ].map((stat, index) => (
                    <motion.div
                      key={stat.label}
                      className="text-center p-4 bg-gradient-to-br from-n0de-green/10 to-n0de-blue/10 rounded-xl border border-n0de-green/20"
                      initial={{ opacity: 0, scale: 0.8 }}
                      whileInView={{ opacity: 1, scale: 1 }}
                      viewport={{ once: true }}
