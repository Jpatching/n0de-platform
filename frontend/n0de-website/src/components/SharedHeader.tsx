...
export default function SharedHeader({ 
  ...
  return (
    <>
      {/* Navigation */}
      <motion.nav 
        className="fixed top-0 left-0 right-0 z-50 bg-bg-main/80 backdrop-blur-md border-b border-border/20"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        ...
        <div className="container-width">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              ...
              />
              <span className="text-xl font-bold hidden sm:flex items-center">
                <span 
                  style={{
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {user ? (
                  ...
                  <AnimatePresence>
                    {profileDropdownOpen && (
                      <motion.div
                        ...
                        className="absolute right-0 mt-2 w-64 bg-bg-card border border-border rounded-lg shadow-xl z-50"
                      >
                        {/* User Info */}
                ...
                whileHover={{ 
                  ...
                  rotateY: 1,
                  boxShadow: [
                    "0 8px 15px rgba(1, 211, 244, 0.15)",
              ...
              <div className="px-4 py-4 space-y-4">
                ...
                <div className="border-t border-border/20 pt-4 space-y-3">
                  ...
                  <button
                    ...
                    className="block w-full px-4 py-2 bg-gradient-to-r from-N0DE-cyan via-N0DE-sky to-N0DE-navy text-white rounded-lg font-medium text-center"
                  >
                    Launch App
                  </button>
                </div>
