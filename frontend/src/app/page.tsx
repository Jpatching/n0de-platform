...
const AnimatedCounter = ({ endValue, suffix = '', label, comparison, delay }: AnimatedCounterProps) => {
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen text-text-primary overflow-x-hidden" style={{ fontFamily: 'var(--font-body)' }}>
      
      {/* Handle auth parameters */}
      <Suspense fallback={null}>
        <AuthHandler setAuthMode={setAuthMode} setShowAuthModal={setShowAuthModal} />
      </Suspense>
        ...
        <div className="container-width flex items-center justify-between py-4">
          <div className="flex items-center gap-12">
            ...
            >
              ...
              <span className="text-2xl font-bold flex items-center" style={{ fontFamily: 'var(--font-display)' }}>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/pricing" className="text-text-secondary hover:text-N0DE-cyan transition-colors">Pricing</Link>
      ...
      <section className="min-h-screen flex items-center section-padding pt-36 relative overflow-hidden hero-section">
          ...
          <div className="text-center max-w-5xl mx-auto">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold mb-6 py-6 sm:py-8 lg:py-12" style={{ fontFamily: 'var(--font-display)', lineHeight: '1.3' }}>
                  ...
                  <ScrollFadeIn direction="right" delay={0.5}>
                    ...
                    >
                      <span
                        style={{
                          background: 'linear-gradient(135deg, #01d3f4 0%, #0b86f8 50%, #01d3f4 100%)',
                          WebkitBackgroundClip: 'text',
                          WebkitTextFillColor: 'transparent',
                          backgroundClip: 'text',
                          color: '#01d3f4',
                          filter: 'drop-shadow(0 0 20px rgba(1,211,244,0.5)) drop-shadow(0 0 40px rgba(1,211,244,0.3))'
                        }}
                      >
                        Dominate
                      </span>
            ...
            <ScrollFadeIn delay={0.9} direction="up" className="mb-8">
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-text-secondary leading-relaxed max-w-4xl mx-auto px-4 sm:px-0">
                <span className="text-[#00ff87] font-semibold drop-shadow-[0_0_10px_rgba(0,255,135,0.5)]">Europe&apos;s Fastest Solana RPC</span> with dedicated enterprise infrastructure.
                <span className="text-[#01d3f4] font-semibold drop-shadow-[0_0_10px_rgba(1,211,244,0.5)]"> 84% faster than QuickNode</span>,
                <span className="text-[#8b5cf6] font-semibold drop-shadow-[0_0_10px_rgba(139,92,246,0.5)]"> 9ms response times</span>, and <span className="text-[#00ff87] font-semibold drop-shadow-[0_0_10px_rgba(0,255,135,0.5)]">perfect reliability</span>.
              </p>
            </ScrollFadeIn>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                {[
                  { icon: Zap, title: "9ms Ultra Performance", desc: "84% faster than QuickNode • Perfect ±1ms consistency • Enterprise AMD EPYC infrastructure", gradientFrom: "N0DE-cyan/20", gradientTo: "N0DE-sky/20", iconColor: "N0DE-cyan", delay: 0 },
                  { icon: Shield, title: "100% Success Rate", desc: "Zero failures while 50% of providers go down • 0 slots behind network • Perfect sync", gradientFrom: "N0DE-sky/20", gradientTo: "N0DE-navy/20", iconColor: "N0DE-sky", delay: 0.1 },
                  { icon: TrendingUp, title: "Europe&apos;s #1 Node", desc: "EU validator proximity • European trading hours • Regulatory clarity", gradientFrom: "N0DE-navy/20", gradientTo: "N0DE-cyan/20", iconColor: "N0DE-navy", delay: 0.2 }
                ].map((card, index) => (
                  <motion.div 
                    key={index}
                  ...
                  >
                    <motion.div 
                      ...
                      whileHover={safeMotionAnimate({ 
                        scale: 1.15,
                        rotate: 5,
                        boxShadow: safeBoxShadow("0 8px 25px rgba(1, 211, 244, 0.3)"),
                    ...
                    >
                      ...
                      >
                        <card.icon className={`w-6 h-6 text-${card.iconColor} group-hover:drop-shadow-glow`} />
                      </motion.div>
                    </motion.div>
                    <motion.h3 
            ...
            <div className="mb-12">
              {/* Top Row Stats */}
              <ScrollStagger staggerDelay={0.1} className="grid grid-cols-2 gap-8 mb-8 max-w-lg mx-auto">
                {[
                  { value: '9ms', label: 'EU Leader', icon: Clock, comparison: '84% faster than QuickNode' },
                  { value: '±1ms', label: 'Consistency', icon: Shield, comparison: 'vs 20-40ms industry variance' }
                ].map((stat, index) => (
                  <div
                    key={stat.label}
                    className="text-center group cursor-pointer"
                  >
                    ...
                    <div className="text-3xl font-bold text-white group-hover:text-N0DE-green transition-colors duration-300" style={{ fontFamily: 'var(--font-display)' }}>
                      {stat.value}
                    </div>
                    <div className="text-text-secondary text-sm">{stat.label}</div>
                    <div className="text-N0DE-cyan text-xs mt-1 font-medium">{stat.comparison}</div>
                  </div>
                ))}
              </ScrollStagger>
              ...
              {/* Bottom Row Stats */}
              <ScrollStagger staggerDelay={0.1} className="grid grid-cols-2 gap-8 max-w-lg mx-auto">
                {[
                  { value: 'EU', label: 'Market Leader', icon: Users },
                  { value: '3M+', label: 'Daily Requests', icon: BarChart3 }
                ].map((stat, index) => (
                  <div
                    key={stat.label}
                    className="text-center group cursor-pointer"
              ...
              <motion.button
                ...
                onClick={() => {
                  try {
                    ...
                    console.error('Error in Get Started Free button click:', error);
                  }
                }}
                className="relative group"
                style={{ 
        ...
        <div className="container-width">
          ...
          <ScrollFadeIn direction="up" className="text-center mb-8">
            <p className="text-text-muted text-base mb-2">Trusted by Solana&apos;s best teams</p>
                    ...
                    [
                      ...
                      <motion.div 
                        ...
                        whileHover={{ 
                          ...
                          y: -12,
                          rotateY: 15,
                          filter: "brightness(1.2) drop-shadow(0 10px 25px rgba(1, 211, 244, 0.5))"
                        }}
                        animate={safeMotionAnimate({
                          y: [0, -3, 0],
                          rotateX: [0, 2, 0],
                        ...
                        transition={{
                          y: { duration: 3 + (logoIndex * 0.3), repeat: Infinity, ease: "easeInOut", delay: setIndex * 0.1 },
                          rotateX: { duration: 4 + (logoIndex * 0.2), repeat: Infinity, ease: "easeInOut", delay: setIndex * 0.15 },
                          filter: { duration: 2.5 + (logoIndex * 0.4), repeat: Infinity, ease: "easeInOut", delay: setIndex * 0.2 }
                        }}
                        style={{ 
                          transformStyle: "preserve-3d",
                          perspective: "1000px"
                    ...
                    [
                      ...
                      <motion.div 
                        ...
                        whileHover={{ 
                          ...
                          y: -12,
                          rotateY: -15,
                          filter: "brightness(1.2) drop-shadow(0 10px 25px rgba(11, 134, 248, 0.5))"
                        }}
                        animate={{
                          y: [0, -2.5, 0],
                          rotateX: [0, -2, 0],
                        ...
                        transition={{
                          y: { duration: 3.5 + (logoIndex * 0.25), repeat: Infinity, ease: "easeInOut", delay: setIndex * 0.12 },
                          rotateX: { duration: 4.2 + (logoIndex * 0.18), repeat: Infinity, ease: "easeInOut", delay: setIndex * 0.18 },
                          filter: { duration: 2.8 + (logoIndex * 0.35), repeat: Infinity, ease: "easeInOut", delay: setIndex * 0.25 }
                        }}
                        style={{ 
                          transformStyle: "preserve-3d",
                          perspective: "1000px"
        ...
        <div className="container-width">
          <ScrollSlideUp>
            <div className="text-center mb-12">
              <h2 className="text-4xl lg:text-5xl font-bold mb-4 text-white" style={{ fontFamily: 'var(--font-display)' }}>
                Everything <span
                  style={{
                    background: 'linear-gradient(135deg, #01d3f4 0%, #0b86f8 50%, #01d3f4 100%)',
                    WebkitBackgroundClip: 'text',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  { icon: Zap, title: "Block 0 Access • Lightning Sniping", desc: "First-mover advantage • Get entries before teams • 9ms response times", color: "N0DE-green" },
                  { icon: Database, title: "Block 0 Priority Lanes", desc: "Guaranteed first-block inclusion • Beat institutional traders • Priority access", color: "N0DE-blue" },
                  { icon: Shield, title: "MEV Protection Suite", desc: "Advanced sandwich attack prevention & private mempool access", color: "N0DE-green" },
                  { icon: TrendingUp, title: "Real-Time Market Data", desc: "gRPC Geyser streams for instant price feeds & account updates", color: "N0DE-blue" }
                ].map((feature, index) => (
                  <motion.div 
                    key={index}
                  ...
                  >
                    <motion.div
                      ...
                      transition={{ type: "spring", stiffness: 500 }}
                    >
                      <feature.icon className={`w-5 h-5 text-${feature.color} mt-1 group-hover:drop-shadow-glow`} />
                    </motion.div>
                    <div>
                      <motion.div 
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  { icon: Shield, title: "Zero KYC • Complete Privacy", desc: "No ID required • Anonymous access • Encrypted connections", color: "N0DE-blue" },
                  { icon: CreditCard, title: "All Major Cryptocurrencies", desc: "SOL • ETH • BTC • USDC • Instant activation", color: "N0DE-green" },
                  { icon: Lock, title: "Military-Grade Security", desc: "End-to-end encryption • DDoS protection • Secure infrastructure", color: "N0DE-blue" },
                  { icon: Users, title: "Elite Trader Community", desc: "Join exclusive alpha groups • Premium support • Trading insights", color: "N0DE-green" }
                ].map((feature, index) => (
                  <motion.div 
                    key={index}
                    className={`flex items-start space-x-3 p-4 rounded-xl hover:bg-${feature.color}/10 border border-transparent hover:border-${feature.color}/20 transition-all duration-300 cursor-pointer group`}
            ...
            <motion.button
              ...
              onClick={() => {
                try {
                  ...
                  console.error('Error in CTA Get Started Free button click:', error);
                }
              }}
        ...
        <div className="container-width relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-xl font-bold" style={{ fontFamily: 'var(--font-display)' }}>N0DE</span>
              </div>
              <p className="text-text-secondary max-w-md">
                Europe&apos;s fastest, most reliable Solana RPC infrastructure. Built for teams who demand excellence.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#" className="block text-text-secondary hover:text-N0DE-cyan transition-colors">RPC Nodes</a>
                <a href="#" className="block text-text-secondary hover:text-N0DE-cyan transition-colors">WebSockets</a>
                <a href="#" className="block text-text-secondary hover:text-N0DE-cyan transition-colors">Analytics</a>
                <a href="#" className="block text-text-secondary hover:text-N0DE-cyan transition-colors">Enterprise</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#" className="block text-text-secondary hover:text-N0DE-cyan transition-colors">About</a>
                <a href="#" className="block text-text-secondary hover:text-N0DE-cyan transition-colors">Blog</a>
                <a href="#" className="block text-text-secondary hover:text-N0DE-cyan transition-colors">Careers</a>
                <a href="#" className="block text-text-secondary hover:text-N0DE-cyan transition-colors">Contact</a>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-border pt-8 flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-6 mt-4 lg:mt-0">
              <a href="#" className="text-text-muted hover:text-N0DE-cyan transition-colors">Privacy</a>
              <a href="#" className="text-text-muted hover:text-N0DE-cyan transition-colors">Terms</a>
              <a href="#" className="text-text-muted hover:text-N0DE-cyan transition-colors">Status</a>
            </div>
          </div>
        </div>
      </footer>
