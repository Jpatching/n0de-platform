...
import { Payment } from "@/types/generated/database.types";
...
function PaymentSuccessContent() {
  ...
  useEffect(() => {
    const checkPaymentStatus = async () => {
      ...
      try {
        const payment = (await api.get(`/payments/${paymentId}`)) as Payment;
  ...
  const planDetails = getPlanDetails(
    (paymentStatus.payment?.metadata?.planType as string) || "PROFESSIONAL",
  );
        ...
        <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              {paymentStatus.payment?.id && (
                <p className="text-sm text-text-muted">
                  Payment ID:{" "}
                  <code className="bg-bg-elevated px-2 py-1 rounded">
                    {paymentStatus.payment.id}
                  </code>
                </p>
              )}
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-text-secondary">
                      You&apos;ll receive your API keys and welcome guide
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-text-secondary">
                      Monitor usage, manage keys, and view analytics
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-8 h-8 bg-n0de-purple/20 rounded-full flex items-center justify-center">
                    <span className="text-n0de-purple font-bold text-sm">
                      3
                    </span>
                  </div>
                  <div>
                    ...
                    <div className="text-sm text-text-secondary">
                      Integrate n0de RPC into your applications
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center mt-8">
            <p className="text-text-secondary text-sm">
              ...
              <a
                href="mailto:support@n0de.com"
                className="text-n0de-blue hover:underline"
              >
