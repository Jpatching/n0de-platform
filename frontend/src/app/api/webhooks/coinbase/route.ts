...
async function activateSubscription(customerEmail: string, planId: string, chargeId: string) {
...
async function sendChargeCreatedEmail(customerEmail: string, details: any) {
  console.log('Sending charge created email to:', customerEmail);
  // Implement email service integration (SendGrid, etc.)
}

async function sendPaymentSuccessEmail(customerEmail: string, details: any) {
  console.log('Sending payment success email to:', customerEmail);
  // Implement email service integration
}

async function sendPaymentFailedEmail(customerEmail: string, details: any) {
  console.log('Sending payment failed email to:', customerEmail);
  // Implement email service integration
}

async function sendPaymentDelayedEmail(customerEmail: string, details: any) {
  console.log('Sending payment delayed email to:', customerEmail);
  // Implement email service integration
}

async function sendApiKeyEmail(customerEmail: string, details: any) {
