...
const TeamPage = () => {
  ...
  // This would be populated from real user data via API
  const teamMembers: TeamMember[] = [
    {
      id: '1',
      name: user?.name || user?.firstName + ' ' + user?.lastName || 'You (Owner)',
      email: user?.email || 'your.email@yourcompany.com',
      role: 'owner',
      lastActive: 'Active now',
      status: 'active'
    }
    // Additional team members would be fetched from /api/team
    // when user invites real team members
  ];
          ...
          <div className="min-h-full bg-black p-6">
            <div className="max-w-2xl mx-auto text-center py-16">
              ...
              >
                ...
                <button className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black px-8 py-3 rounded-xl font-semibold hover:from-yellow-600 hover:to-orange-600 transition-all duration-200 flex items-center mx-auto">
